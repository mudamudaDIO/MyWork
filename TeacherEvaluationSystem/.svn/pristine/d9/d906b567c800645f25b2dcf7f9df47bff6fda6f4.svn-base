                ...
                <form class="layui-form" id="form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="sub_id" name=sub_id required="" lay-verify="" autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="sub_name" name="sub_name" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                //监听提交
               	...
               	url= "${pageContext.request.contextPath}/admin/addSubjectSubmit";
