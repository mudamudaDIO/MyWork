                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
						<div class="layui-card-header">
                            <button class="layui-btn" onclick="xadmin.open('添加角色','addRoles',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                                ...
                                <tbody>
                     				<c:forEach items="${roles}" var="role">
                     					<tr>
	                     					...
	                     					<td class="td-manage">
		                                      <a title="修改"  onclick="xadmin.open('修改','updateRole?id=${role.role_id}',600,400)" href="javascript:;">
