                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">
        					<button class="layui-btn" onclick="xadmin.open('添加试题','./addTest',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                                ...
                                <tbody>
                     				<c:forEach items="${question}" var="q">
                     					<tr>
	                     					...
	                     					<td>${q.answer_D} </td>
	                     					<td class="td-manage">
		                                      <a title="编辑"  onclick="xadmin.open('编辑','updateTest?id=${q.question_id}',600,400)" href="javascript:;">
		                                        <i class="layui-icon">&#xe642;</i>
		                                      </a>		                                  
		                                      <a title="删除" onclick="member_del(this,'${q.question_id}')" href="javascript:;">
		                                        <i class="layui-icon">&#xe640;</i>
		                                      </a>
	                                    	</td>
                                    	</tr>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
             parm={id:id}
         	 url= "${pageContext.request.contextPath}/admin/delQuestion";
