                ...
                <form class="layui-form" id="form">
                    <div class="layui-form-item">
                        <label for="L_email" class="layui-form-label">
                            <span class="x-red">*</span>学院编号</label>
                        <div class="layui-input-inline">
                            <input type="text" id="ins_id" name=ins_id required="" lay-verify="" autocomplete="off" class="layui-input"></div>
                    </div>
                    
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>学院名</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_insname" name="ins_name" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                //监听提交
               	...
               	url= "${pageContext.request.contextPath}/admin/addInsSubmit";
