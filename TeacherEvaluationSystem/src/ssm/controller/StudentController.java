...
public class StudentController {
	...
	public ModelAndView teacherList(HttpSession session) {
		...
		for(Subject s:sub) {//遍历获取的课程		
			...
			list.add(teacher);		
			//System.out.println(teacher.getTeacher_name()+" "+teacher.getIns().getIns_name()+" "+teacher.getSubject().getSubject_name());
		}
	...
	public ResultMsg voteTeacher(int studentid,int teacherid,String id1,String id2,String id3
		...
		int score=Score.countScore(id1, id2, id3, id4, id5, id6, id7, id8, id9, id10);
