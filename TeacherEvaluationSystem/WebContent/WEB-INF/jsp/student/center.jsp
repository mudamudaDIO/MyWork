...
<body>
<div class="main">
<div class="top">学生信息</div>
<table>
		<tr>
			<th>学生姓名:</th>
			<td colspan="2">${studentmsg.student_name}</td>
		</tr>
		<tr>
			<th>学&nbsp;&nbsp;&nbsp;&nbsp;号:</th>
			<td colspan="2">${studentmsg.student_id}</td>
		</tr>
		<tr>
			<th>所在学院:</th>
			<td colspan="2">${studentmsg.ins.ins_name}</td>
		</tr>
		<tr>
			<th>所在班级:</th>
			<td colspan="2">${studentmsg.classroom.class_name}</td>
		</tr>
</table>
</div>
</body>
