    ...
    <body>
                ...
                <form class="layui-form" id="form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="sub_name" value="${sub.subject_name }" name="sub_name" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        			<input type="hidden" value="${sub.subject_id}" name="id">
                    <div class="layui-form-item">
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                url= "${pageContext.request.contextPath}/admin/changeSub";
