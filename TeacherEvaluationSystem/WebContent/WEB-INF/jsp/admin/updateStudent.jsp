                ...
                <form class="layui-form" id="form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="student_name" value="${student.student_name}" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                //监听提交
             	...
             	url= "${pageContext.request.contextPath}/admin/ChangeStudent";
