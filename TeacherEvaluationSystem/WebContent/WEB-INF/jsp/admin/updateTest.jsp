                ...
                <form class="layui-form" id="form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="question" value="${question.question}" name=question required="" lay-verify="" autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" value="${question.answer_A}" name="answer_A" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" value="${question.answer_B}" name="answer_B" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" value="${question.answer_C}" name="answer_C" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" value="${question.answer_D}" name="answer_D" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                //监听提交
               	...
               	url= "${pageContext.request.contextPath}/admin/ChangeTest";
