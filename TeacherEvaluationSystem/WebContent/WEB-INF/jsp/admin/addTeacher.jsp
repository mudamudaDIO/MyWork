                ...
                <form class="layui-form" id="form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="student_id" name=teacher_id required="" lay-verify="student_id" autocomplete="off" class="layui-input"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="teacher_name" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['form', 'layer','jquery'],
            function() {
                ...
                form.verify({
					...
					student_id:[/^[0-9]{5,}$/, '工号至少为5位纯数字']
                });

                //监听提交
              	
               	url= "${pageContext.request.contextPath}/admin/addTeacherSubmit";
